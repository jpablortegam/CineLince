...
CREATE TRIGGER after_calificacion_insert
    AFTER INSERT ON CalificacionPelicula
    FOR EACH ROW
BEGIN
    UPDATE Pelicula
...
CREATE TRIGGER after_calificacion_update
    AFTER UPDATE ON CalificacionPelicula
    FOR EACH ROW
BEGIN
    UPDATE Pelicula
    SET CalificacionPromedio = (
...
CREATE TRIGGER after_calificacion_delete
    AFTER DELETE ON CalificacionPelicula
    FOR EACH ROW
BEGIN
    UPDATE Pelicula
    SET CalificacionPromedio = COALESCE((
                                            SELECT AVG(Calificacion)
                                            FROM CalificacionPelicula
...
INSERT INTO Cine (IdCine, Nombre, Direccion, Ciudad, Estado, CodigoPostal, Telefono, HoraApertura, HoraCierre) VALUES
                                                                                                                   ...
                                                                                                                   (3,'Cinépolis Galerías Monterrey','Av. Insurgentes 2500, Vista Hermosa','Monterrey','Nuevo León','64620','8181234567','10:30:00','00:30:00'),
                                                                                                                   (4,'Cinemex Plaza Patria','Av. Patria 1950, Zapopan','Guadalajara','Jalisco','45160','3331234567','11:30:00','01:30:00');
...
INSERT INTO Estudio (IdEstudio, Nombre, Pais, Descripcion) VALUES
                                                               ...
                                                               (6,'A24','Estados Unidos','Estudio de cine independiente.'); -- Añadido Estudio con ID 6
...
INSERT INTO Pelicula (IdPelicula, Titulo, Duracion, Sinopsis, FechaEstreno, Clasificacion, Idioma, Subtitulada, Fotografia, Formato, Estado, IdEstudio, IdDirector, IdTipoPelicula) VALUES
                                                                                                                                                                                        ...
                                                                                                                                                                                        (10,'La La Land',128,'Amor en LA entre pianista y actriz.','2016-12-09','PG-13','Inglés',FALSE,'posters/lalaland.jpg','2D','En Cartelera',6,NULL,7), -- IdEstudio 6
                                                                                                                                                                                        (11,'Todo en Todas Partes al Mismo Tiempo',139,'Inmigrante explora universos.','2022-03-25','R','Inglés',TRUE,'posters/everything_everywhere.jpg','2D','En Cartelera',6,NULL,1); -- IdEstudio 6
...
INSERT INTO Sala (IdSala, Numero, Capacidad, TipoSala, Estado, IdCine) VALUES
                                                                           ...
                                                                           (13,2,60,'Platino','Disponible',4); -- Cine 4
...
INSERT INTO Boleto (IdBoleto, PrecioFinal, FechaCompra, CodigoQR, IdFuncion, IdCliente, IdAsiento, IdVenta) VALUES
                                                                                                                ...
                                                                                                                (3,108.00,'2025-05-25 18:30:00','QR20250525001C10F2',2,NULL,5,2), -- Precio de Venta 2 se actualizó, este podría ajustarse
                                                                                                                (4,95.00,'2025-05-26 17:45:00','QR20250526001A1F5',5,6,8,4),
                                                                                                                (5,95.00,'2025-05-26 17:45:00','QR20250526001A2F5',5,NULL,9,4),
                                                                                                                (6,120.00,'2025-05-26 20:30:00','QR20250526001B5F9',6,4,11,5), -- Precio de Venta 5 se actualizó, este podría ajustarse
                                                                                                                (7,120.00,'2025-05-26 20:30:00','QR20250526001B6F9',6,4,12,5), -- Precio de Venta 5 se actualizó, este podría ajustarse
                                                                                                                (8,100.00,'2025-05-28 16:15:00','QR20250528001XXF9',9,7,NULL,6),
                                                                                                                (9,100.00,'2025-05-28 16:15:00','QR20250528002XXF9',9,7,NULL,6),
                                                                                                                (10,110.00,'2025-05-27 16:30:00','QR20250527001XXF13',13,5,NULL,10), -- Esta venta usa promo 2x1, podrían ser 2 boletos por 55 c/u
                                                                                                                (11,0.00,'2025-05-27 16:30:00','QR20250527002XXF13',13,5,NULL,10); -- O el segundo boleto de la promo 2x1
...
INSERT INTO DetalleVenta (IdDetalleVenta, Cantidad, PrecioUnitario, Subtotal, IdVenta, IdProducto) VALUES
                                                                                                       (1,1,150.00,150.00,2,4), -- Venta 2, Combo Pareja. El total de venta se ajustó a 258, aquí hay 150. Faltan 108
                                                                                                       ...
                                                                                                       (8,1,45.00,45.00,9,1);   -- Venta 9, Refresco. Suma 50+45 = 95. OK.
...
INSERT INTO CalificacionPelicula (IdPelicula, IdCliente, Calificacion, Comentario) VALUES
                                                                                       (1, 1, 4.5, 'Excelente película, gran dirección y actuaciones. ¡Un clásico moderno!'),
